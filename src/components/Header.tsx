import { Menu, X, Home, User, Briefcase, Cpu, Phone } from 'lucide-react';
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 z-[65] bg-slate-950/60 backdrop-blur-3xl md:hidden flex flex-col justify-center px-8"
            >
              ...
              <motion.div 
                ...
                className="absolute bottom-12 left-8 right-8 py-8 border-t border-white/10 flex justify-between items-center"
              >
